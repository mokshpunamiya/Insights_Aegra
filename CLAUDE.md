...
aegra/
├── libs/
│   ├── aegra-api/                    # Core API package (Framework)
│   └── aegra-cli/                    # CLI package (Framework)
│
├── eerly_studio/                     # Business Logic and Insights Agent
│   ├── artifacts/                    # Runtime charts/data/logs
│   ├── scripts/                      # Utility scripts (export graph, tests)
│   └── src/eerly_studio/
│       ├── auth/                     # Authentication service
│       ├── core/                     # Database & migrations
│       └── insights/                 # Multi-Agent Data Intelligence Graph
│           ├── graph.py              # Main graph entry point (Postgres persistence)
│           ├── runner.py             # CLI runner for insights
│           ├── agents/               # Orchestrator, DE, DS, Synthesizer nodes
│           ├── tools/                # Qdrant, SQL, E2B tools
│           └── prompts/              # Jinja2 templates for nodes
│
├── agent-chat-ui-main/               # Professional Next.js Frontend
├── aegra.json                        # Project configuration (Insights graph only)
├── README.md                         # Professional documentation with Architecture
└── docker-compose.yml                # Local development infrastructure
```

**Key principle:** LangGraph handles ALL state persistence and graph execution. Insights logic is decoupled from Aegra core.
